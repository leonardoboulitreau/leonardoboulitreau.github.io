...
<table style="border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    <tr>
      ...
      <td style="padding: 8px 12px; text-align: center;" rowspan="5"><img src="/_papers/PitchSTAR/pictures/output.png" alt="reference spectrogram" style="max-width: 500px; width: 100%;"></td>
      ...
      <td style="padding: 8px 12px; text-align: center;" rowspan="5"><img src="/_papers/PitchSTAR/pictures/output.png" alt="spectrogram" style="max-width: 500px; width: 100%;"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="padding: 8px 12px;">Condition E</td>
      <td style="padding: 8px 12px; text-align: center;"><div class="essential_audio" data-url="/_papers/PitchSTAR/audios/glissando_strong_ref.wav"></div></td>
    </tr>
    <tr>
