...
<table style="border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    <tr>
      ...
      <td style="padding: 8px 12px; text-align: center;" rowspan="4"><audio controls style="width: 80px;"><source src="/_papers/PitchSTAR/audios/glissando_strong_ref.wav" type="audio/wav"></audio></td>
      ...
      <td style="padding: 8px 12px; text-align: center;"><audio controls style="width: 80px;"><source src="/_papers/PitchSTAR/audios/glissando_strong_ref.wav" type="audio/wav"></audio></td>
